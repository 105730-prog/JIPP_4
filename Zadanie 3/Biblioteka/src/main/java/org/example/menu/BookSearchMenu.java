...
public class BookSearchMenu extends MenuState{

    public BookSearchMenu(Menu menu, Scanner scanner){
        super(menu, scanner);
    }
    ...
    public int readOptions(int optionsCount) {
        ...
        switch (option){
            ...
            case 0 -> this.menu.changeState(new AdminLibraryMenu(this.menu, this.scanner));
        }
